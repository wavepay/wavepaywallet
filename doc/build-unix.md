...
If you want to build Wavepay-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a wavepay-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the wavepay directory
BDB_PREFIX="${WAVEPAY_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Wavepay Core to use our own-built instance of BDB
cd $WAVEPAY_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip wavepayd" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Wavepayd with compile script
---------------------
...
Security
---------------------
To help make your wavepay installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, wavepay should be built with a non-executable stack
