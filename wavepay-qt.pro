...
HEADERS += src/qt/bitcoingui.h \
    ...
    src/qt/whitepaperdialog.h \
    src/qt/guidedialog.h \
...
SOURCES += src/qt/bitcoin.cpp src/qt/bitcoingui.cpp \
    ...
    src/qt/whitepaperdialog.cpp \
    src/qt/guidedialog.cpp \
...
FORMS += \
    ...
    src/qt/forms/whitepaperdialog.ui \
    src/qt/forms/guidedialog.ui \
...
isEmpty(MINIUPNPC_INCLUDE_PATH) {
    macx:MINIUPNPC_INCLUDE_PATH=/usr/local/Cellar/miniupnpc/2.0.20180203/include
    windows:MINIUPNPC_INCLUDE_PATH=C:/deps/miniupnpc
}

isEmpty(MINIUPNPC_LIB_PATH) {
    macx:MINIUPNPC_LIB_PATH=/usr/local/Cellar/miniupnpc/2.0.20180203/lib
    windows:MINIUPNPC_LIB_PATH=C:/deps/miniupnpc/miniupnpc
}
...
isEmpty(OPENSSL_LIB_PATH) {
    ...
    windows:OPENSSL_LIB_PATH=C:/deps/openssl-1.0.1l/lib
}

isEmpty(GMP_INCLUDE_PATH) {
    macx:GMP_INCLUDE_PATH = /usr/local/Cellar/gmp/6.1.2_1/include
    windows:GMP_INCLUDE_PATH=C:/deps/gmp-6.0.0
}

isEmpty(GMP_LIB_PATH) {
    macx:GMP_LIB_PATH = /usr/local/Cellar/gmp/6.1.2_1/lib
    windows:GMP_LIB_PATH=C:/deps/gmp-6.0.0/.libs
}
...
macx:ICON = src/qt/res/icons/wavepay.icns
macx:TARGET = "Wavepay-Qt"
