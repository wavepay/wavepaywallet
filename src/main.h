...
#define START_MASTERNODE_PAYMENTS_TESTNET 1529028000
#define START_MASTERNODE_PAYMENTS 1529028000 // Friday, June 15, 2018 2:00:00 AM
#define START_POW_MASTERNODE_PAYMENTS_TESTNET 1528423200 // Friday, June 8, 2018 2:00:00 AM
#define START_POW_MASTERNODE_PAYMENTS 1528423200
...
static const unsigned int MAX_STWVPARD_TX_SIZE = MAX_BLOCK_SIZE_GEN/5;
...
static const int64_t MIN_TX_FEE = 0.000001*COIN;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 25000000 * COIN; // 25M  coins
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC

static const int64_t DRIFT = 300;
...
public:
    ...
    bool ConnectInputs(CTxDB& txdb, MapPrevTx inputs,
                       ...
                       const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags = STWVPARD_SCRIPT_VERIFY_FLAGS, bool fValidateSig = true);
