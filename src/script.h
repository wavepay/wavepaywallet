...
// details.
static const unsigned int MWVPATORY_SCRIPT_VERIFY_FLAGS = SCRIPT_VERIFY_NONE;

// Standard script verification flags that standard transactions will comply
// with. However scripts violating these flags may still be present in valid
// blocks and we must accept those blocks.
static const unsigned int STWVPARD_SCRIPT_VERIFY_FLAGS = MWVPATORY_SCRIPT_VERIFY_FLAGS |
                                                         SCRIPT_VERIFY_STRICTENC |
                                                         SCRIPT_VERIFY_NULLDUMMY |
                                                         SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS;

// For convenience, standard but not mandatory verify flags.
static const unsigned int STWVPARD_NOT_MWVPATORY_VERIFY_FLAGS = STWVPARD_SCRIPT_VERIFY_FLAGS & ~MWVPATORY_SCRIPT_VERIFY_FLAGS;
 ...
 *  A CTxDestination is the internal data type encoded in a CWavepaycoinAddress
 */
