    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 20000 WVP TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter your transaction output index");
    ui->donationaddressLineEdit->setPlaceholderText("Enter WVPcoin address for your MN donation");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:5279)");
        msg.exec();
        return;
    }
