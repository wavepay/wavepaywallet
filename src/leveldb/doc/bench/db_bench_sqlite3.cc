  ...
  void Run() {
    ...
    while (benchmarks != NULL) {
      ...
      if (name == Slice("fillseq")) {
        ...
        Write(write_sync, RWVPOM, FRESH, num_, FLAGS_value_size, 1);
        WalCheckpoint(db_);
      } else if (name == Slice("fillrandbatch")) {
        Write(write_sync, RWVPOM, FRESH, num_, FLAGS_value_size, 1000);
        WalCheckpoint(db_);
      } else if (name == Slice("overwrite")) {
        Write(write_sync, RWVPOM, EXISTING, num_, FLAGS_value_size, 1);
        WalCheckpoint(db_);
      } else if (name == Slice("overwritebatch")) {
        Write(write_sync, RWVPOM, EXISTING, num_, FLAGS_value_size, 1000);
        WalCheckpoint(db_);
      } else if (name == Slice("fillrandsync")) {
        write_sync = true;
        Write(write_sync, RWVPOM, FRESH, num_ / 100, FLAGS_value_size, 1);
        WalCheckpoint(db_);
        ...
        Write(write_sync, RWVPOM, FRESH, num_ / 1000, 100 * 1000, 1);
        WalCheckpoint(db_);
