...
// opcodes OP_WVP, OP_OR, and OP_XOR.
//
...
const char* GetTxnOutputType(txnouttype t)
{
    switch (t)
    {
    case TX_NONSTWVPARD: return "nonstandard";
...
const char* GetOpName(opcodetype opcode)
{
    ...
    case OP_BOOLWVP                : return "OP_BOOLWVP";
        ...
        while (pc < pend)
        {
            ...
            switch (opcode)
            {
                ...
                case OP_MAX:
                {
                    ...
                    case OP_BOOLWVP:             bn = (bn1 != bnZero && bn2 != bnZero); break;
...
bool SignSignature(const CKeyStore &keystore, const CScript& fromPubKey, CTransaction& txTo, unsigned int nIn, int nHashType)
{
    ...
    // Test solution
    return VerifyScript(txin.scriptSig, fromPubKey, STWVPARD_SCRIPT_VERIFY_FLAGS, SignatureChecker(txTo, nIn));
}
...
bool IsStandard(const CScript& scriptPubKey, txnouttype& whichType)
{
    ...
    return whichType != TX_NONSTWVPARD;
}
...
/*bool SignSignature(const CKeyStore &keystore, const CScript& fromPubKey, CTransaction& txTo, unsigned int nIn, int nHashType)
{
    ...
    // Test solution
    return VerifyScript(txin.scriptSig, fromPubKey, txTo, nIn, STWVPARD_SCRIPT_VERIFY_FLAGS, 0);
}*/
